...
describe Server::Helpers::Supermarket do
  ...
  it 'returns the PATH of the supermarket lock file' do
    expect(described_class.supermarket_lock_file(node)).to eq File.join(Chef::Config.chef_repo_path, '.chef', 'provisioning-data-chefspec', 'supermarket')
  end
